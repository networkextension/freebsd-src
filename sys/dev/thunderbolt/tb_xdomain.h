...
/* Invoked (interrupt context) when a session bootstraps from a peer request. */
typedef void (tb_xdomain_peer_cb)(void *ctx, const uint8_t *peer_uuid,
...
void tb_xdomain_set_peer_handler(struct tb_xdomain *xd,
